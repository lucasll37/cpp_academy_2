...
\begin{itemize}
    \item Documento n\textsuperscript{o} MIIA-VP-49290a7f, ``\textbf{Visão de Produto}'', Instituto de Estudos Avançados (IEAv), 2025
    \item Repositório MIIA, Merge Request 10, \url{https://gitlab.asa.dcta.mil.br/asa/miia/-/commit/9811d09abd5180fac9fac4a377f6987685d9e009}, Instituto de Estudos Avançados (IEAv), 2026
\end{itemize}
\newpage
